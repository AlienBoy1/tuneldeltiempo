          ...
          {order ? (
            <>
              ...
              <div className="space-y-6 lg:text-lg sm:text-base text-sm">
                ...
                >
                  <h1 className="font-semibold mb-4">Estado del Pedido</h1>
                ...
                <div>
                  <h3 className="font-semibold mb-2 uppercase">Dirección </h3>
                  <div className="text-sm text-gray-700">
                    ...
                    <p>
                      <span className="font-semibold">Línea 1 - </span>
                      {order?.shipping?.address?.line1},
                    </p>
                    <p>
                      <span className="font-semibold">Línea 2 - </span>
                ...
                <div>
                  <h3 className="font-semibold mb-2  uppercase">Monto</h3>
                  <div className="text-sm text-gray-700">
                    <p>
                ...
                <div>
                  <h4 className="font-semibold mb-2  uppercase">Artículos</h4>
