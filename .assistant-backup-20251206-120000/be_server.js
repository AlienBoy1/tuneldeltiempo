...
function ensureVapid() {
  ...
  if (!publicKey || !privateKey) {
    ...
    webpush.setVapidDetails('mailto:admin@zinger.local', keys.publicKey, keys.privateKey);
    return keys;
  }
  webpush.setVapidDetails('mailto:admin@zinger.local', publicKey, privateKey);
